...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header  text-center text-white bg-success">Declaración del Impuesto Sobre Hospedaje</div>
                <div class="card-body">
                    @if (session('status'))
...
<!--</form>-->
                    ...
                    <div class="form-group row"> 
                        <div class="col-md-6">
                            <label for="trabajadores" class="col-form-label">{{ __('Total de Facturas:') }}</label>
